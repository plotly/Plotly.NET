...
let printUsage () =
    eprintfn
        "Usage: dotnet fsi .codex/skills/chart-baseline-generation/scripts/generate-chart-markup.fsx -- [html|all|data|layout|config|plotly-call] [--write-html <output-path>]"

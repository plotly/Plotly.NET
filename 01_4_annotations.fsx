...
<div id="27a0ccf3-fb86-4e34-9fce-4f08b8ab6071"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_27a0ccf3fb864e349fce4f08b8ab6071 = function() {
            ...
            Plotly.newPlot('27a0ccf3-fb86-4e34-9fce-4f08b8ab6071', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_27a0ccf3fb864e349fce4f08b8ab6071();
                };

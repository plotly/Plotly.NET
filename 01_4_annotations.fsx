...
<div id="0a58f825-743a-45d3-a05d-1e28dd0011c1"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_0a58f825743a45d3a05d1e28dd0011c1 = function() {
            ...
            Plotly.newPlot('0a58f825-743a-45d3-a05d-1e28dd0011c1', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_0a58f825743a45d3a05d1e28dd0011c1();
                };

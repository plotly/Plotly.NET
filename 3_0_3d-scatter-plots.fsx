...
<div id="1786e6b4-d9fd-465f-8d9c-ac479ad705da" style="width: 800px; height: 800px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_1786e6b4d9fd465f8d9cac479ad705da = function() {
            ...
            var config = {};
            Plotly.newPlot('1786e6b4-d9fd-465f-8d9c-ac479ad705da', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_1786e6b4d9fd465f8d9cac479ad705da();
                };

...
<div id="c99abe49-8b03-45ba-92a7-ba7cee2434b2" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c99abe498b0345ba92a7ba7cee2434b2 = function() {
            ...
            var config = {};
            Plotly.newPlot('c99abe49-8b03-45ba-92a7-ba7cee2434b2', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_c99abe498b0345ba92a7ba7cee2434b2();
                };

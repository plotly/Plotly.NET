...
<div id="0dfddb6a-20d4-4bcc-a90e-23e070b51a59" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_0dfddb6a20d44bcca90e23e070b51a59 = function() {
            ...
            var config = {};
            Plotly.newPlot('0dfddb6a-20d4-4bcc-a90e-23e070b51a59', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_0dfddb6a20d44bcca90e23e070b51a59();
                };

...
[![Binder](https://plotly.net/img/badge-binder.svg)](https://mybinder.org/v2/gh/plotly/Plotly.NET/gh-pages?filepath=9_2_sankey.ipynb)&emsp;
[![Script](https://plotly.net/img/badge-script.svg)](https://plotly.net/9_2_sankey.fsx)&emsp;
[![Notebook](https://plotly.net/img/badge-notebook.svg)](https://plotly.net/9_2_sankey.ipynb)
...
<div id="e9fe80a4-a044-4369-8a80-bbd778171679" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_e9fe80a4a04443698a80bbd778171679 = function() {
            ...
            var config = {};
            Plotly.newPlot('e9fe80a4-a044-4369-8a80-bbd778171679', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_e9fe80a4a04443698a80bbd778171679();
                };

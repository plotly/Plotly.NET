...
<div id="f2862e02-d5d2-4476-938e-65b92ad597ed"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f2862e02d5d24476938e65b92ad597ed = function() {
            ...
            Plotly.newPlot('f2862e02-d5d2-4476-938e-65b92ad597ed', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f2862e02d5d24476938e65b92ad597ed();
                };

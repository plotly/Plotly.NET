...
<div id="3e6279f0-fbbd-47d7-81b8-c974bde79871"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_3e6279f0fbbd47d781b8c974bde79871 = function() {
            ...
            Plotly.newPlot('3e6279f0-fbbd-47d7-81b8-c974bde79871', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_3e6279f0fbbd47d781b8c974bde79871();
                };

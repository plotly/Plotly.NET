...
<div id="46d8c03b-db1a-4d35-b50f-4904640b7c3e" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_46d8c03bdb1a4d35b50f4904640b7c3e = function() {
            ...
            var config = {};
            Plotly.newPlot('46d8c03b-db1a-4d35-b50f-4904640b7c3e', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_46d8c03bdb1a4d35b50f4904640b7c3e();
                };

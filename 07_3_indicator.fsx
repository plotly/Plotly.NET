...
<div id="52fa02ff-e242-4378-9697-546fa2184e80"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_52fa02ffe24243789697546fa2184e80 = function() {
            ...
            Plotly.newPlot('52fa02ff-e242-4378-9697-546fa2184e80', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_52fa02ffe24243789697546fa2184e80();
                };

...
<div id="ae445b14-632c-4c9d-bf60-f0199f31dfc3"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_ae445b14632c4c9dbf60f0199f31dfc3 = function() {
            ...
            Plotly.newPlot('ae445b14-632c-4c9d-bf60-f0199f31dfc3', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_ae445b14632c4c9dbf60f0199f31dfc3();
                };

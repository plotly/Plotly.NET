...
<div id="8a42d95a-19b8-4e1a-8632-575907ab8ea0" style="width: 700px; height: 500px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_8a42d95a19b84e1a8632575907ab8ea0 = function() {
            ...
            var config = {};
            Plotly.newPlot('8a42d95a-19b8-4e1a-8632-575907ab8ea0', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_8a42d95a19b84e1a8632575907ab8ea0();
                };
...
<div id="ea03d5c1-94a2-416f-9449-0657e60d6a72" style="width: 700px; height: 500px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_ea03d5c194a2416f94490657e60d6a72 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var layout = {"width":700.0,"height":500.0,"margin":{"l":200.0}};
            var config = {};
            Plotly.newPlot('ea03d5c1-94a2-416f-9449-0657e60d6a72', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_ea03d5c194a2416f94490657e60d6a72();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

...
<div id="dc0a45e6-6eca-48de-a760-d2bcbf99363a"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_dc0a45e66eca48dea760d2bcbf99363a = function() {
            ...
            Plotly.newPlot('dc0a45e6-6eca-48de-a760-d2bcbf99363a', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_dc0a45e66eca48dea760d2bcbf99363a();
                };

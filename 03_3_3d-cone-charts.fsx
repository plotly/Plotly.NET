...
<div id="f06222cf-fbea-4606-a94e-f19860ac3324"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f06222cffbea4606a94ef19860ac3324 = function() {
            ...
            Plotly.newPlot('f06222cf-fbea-4606-a94e-f19860ac3324', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f06222cffbea4606a94ef19860ac3324();
                };

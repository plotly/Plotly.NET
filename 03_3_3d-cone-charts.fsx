...
<div id="bc561fd2-b6e1-46d4-b6e6-9fad6334fd61"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_bc561fd2b6e146d4b6e69fad6334fd61 = function() {
            ...
            Plotly.newPlot('bc561fd2-b6e1-46d4-b6e6-9fad6334fd61', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_bc561fd2b6e146d4b6e69fad6334fd61();
                };

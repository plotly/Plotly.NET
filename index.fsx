...
You can find all available package versions on the [nuget page](https://www.nuget.org/packages/Plotly.NET/).
 ...
 - dotnet CLI
    ...
    ```shell
    dotnet add package Plotly.NET --version 2.0.0-beta.10
    ```

 - paket CLI

    ```shell
    paket add Plotly.NET --version 2.0.0-beta.10
    ```

 - package manager

    ```shell
    Install-Package Plotly.NET -Version 2.0.0-beta.10
    ```

    Or add the package reference directly to your `.*proj` file:

    ```
    <PackageReference Include="Plotly.NET" Version="2.0.0-beta.10" />
    ```
...
```
#r "nuget: Plotly.NET, 2.0.0-beta.10"
```
...
<div id="f6f14907-5d07-4175-ba8f-6ac28e5627f2" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f6f149075d074175ba8f6ac28e5627f2 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('f6f14907-5d07-4175-ba8f-6ac28e5627f2', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f6f149075d074175ba8f6ac28e5627f2();
                };
...
<div id="74af5e2d-d4aa-4712-b7af-f1b6665d31a2" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_74af5e2dd4aa4712b7aff1b6665d31a2 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('74af5e2d-d4aa-4712-b7af-f1b6665d31a2', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_74af5e2dd4aa4712b7aff1b6665d31a2();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

...
You can find all available package versions on the [nuget page](https://www.nuget.org/packages/Plotly.NET/).
 ...
 - dotnet CLI
    ...
    ```shell
    dotnet add package Plotly.NET --version 2.0.0-preview.15
    ```

 - paket CLI

    ```shell
    paket add Plotly.NET --version 2.0.0-preview.15
    ```

 - package manager

    ```shell
    Install-Package Plotly.NET -Version 2.0.0-preview.15
    ```

    Or add the package reference directly to your `.*proj` file:

    ```
    <PackageReference Include="Plotly.NET" Version="2.0.0-preview.15" />
    ```
...
<div id="30e34e8c-eb41-4fda-8a93-63284be72ed0"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_30e34e8ceb414fda8a9363284be72ed0 = function() {
            ...
            Plotly.newPlot('30e34e8c-eb41-4fda-8a93-63284be72ed0', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_30e34e8ceb414fda8a9363284be72ed0();
                };
...
<div id="2e2ba9c4-a22c-4f73-9795-9aec1a121bd5"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_2e2ba9c4a22c4f7397959aec1a121bd5 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.4.2.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('2e2ba9c4-a22c-4f73-9795-9aec1a121bd5', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_2e2ba9c4a22c4f7397959aec1a121bd5();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

...
You can find all available package versions on the [nuget page](https://www.nuget.org/packages/Plotly.NET/).
 ...
 - dotnet CLI
    ...
    ```shell
    dotnet add package Plotly.NET --version 2.0.0-preview.14
    ```

 - paket CLI

    ```shell
    paket add Plotly.NET --version 2.0.0-preview.14
    ```

 - package manager

    ```shell
    Install-Package Plotly.NET -Version 2.0.0-preview.14
    ```

    Or add the package reference directly to your `.*proj` file:

    ```
    <PackageReference Include="Plotly.NET" Version="2.0.0-preview.14" />
    ```
...
<div id="499545e7-0f22-4046-9bdf-efb1beb729ac"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_499545e70f2240469bdfefb1beb729ac = function() {
            ...
            Plotly.newPlot('499545e7-0f22-4046-9bdf-efb1beb729ac', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_499545e70f2240469bdfefb1beb729ac();
                };
...
<div id="e6ead633-8df9-4b5f-8734-324f4d61a496"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_e6ead6338df94b5f8734324f4d61a496 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.4.2.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('e6ead633-8df9-4b5f-8734-324f4d61a496', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_e6ead6338df94b5f8734324f4d61a496();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

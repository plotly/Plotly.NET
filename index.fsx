...
You can find all available package versions on the [nuget page](https://www.nuget.org/packages/Plotly.NET/).
 ...
 - dotnet CLI
    ...
    ```shell
    dotnet add package Plotly.NET --version 2.0.0-preview.18
    ```

 - paket CLI

    ```shell
    paket add Plotly.NET --version 2.0.0-preview.18
    ```

 - package manager

    ```shell
    Install-Package Plotly.NET -Version 2.0.0-preview.18
    ```

    Or add the package reference directly to your `.*proj` file:

    ```
    <PackageReference Include="Plotly.NET" Version="2.0.0-preview.18" />
    ```
...
<div id="da9eac43-52e1-4cae-af13-5ee9b2c87ff5"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_da9eac4352e14caeaf135ee9b2c87ff5 = function() {
            ...
            Plotly.newPlot('da9eac43-52e1-4cae-af13-5ee9b2c87ff5', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_da9eac4352e14caeaf135ee9b2c87ff5();
                };
...
<div id="bbfe0710-b344-4bf6-8094-fb5febdfd332"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_bbfe0710b3444bf68094fb5febdfd332 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('bbfe0710-b344-4bf6-8094-fb5febdfd332', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_bbfe0710b3444bf68094fb5febdfd332();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

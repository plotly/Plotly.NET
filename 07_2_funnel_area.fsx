...
<div id="ccc4c2d2-a7c7-46e4-aa46-b7a6ac8fe023"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_ccc4c2d2a7c746e4aa46b7a6ac8fe023 = function() {
            ...
            Plotly.newPlot('ccc4c2d2-a7c7-46e4-aa46-b7a6ac8fe023', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_ccc4c2d2a7c746e4aa46b7a6ac8fe023();
                };

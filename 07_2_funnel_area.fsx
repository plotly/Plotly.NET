...
<div id="80a2bea8-03d4-45f6-ba98-dc309f8f1432"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_80a2bea803d445f6ba98dc309f8f1432 = function() {
            ...
            Plotly.newPlot('80a2bea8-03d4-45f6-ba98-dc309f8f1432', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_80a2bea803d445f6ba98dc309f8f1432();
                };

...
<div id="b8acb0f8-451e-4f01-9811-0cfc3e033185"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_b8acb0f8451e4f0198110cfc3e033185 = function() {
            ...
            Plotly.newPlot('b8acb0f8-451e-4f01-9811-0cfc3e033185', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_b8acb0f8451e4f0198110cfc3e033185();
                };

...
<div id="89b6f224-a24a-45b7-ac59-4df0923acd96"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_89b6f224a24a45b7ac594df0923acd96 = function() {
            ...
            Plotly.newPlot('89b6f224-a24a-45b7-ac59-4df0923acd96', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_89b6f224a24a45b7ac594df0923acd96();
                };

...
<div id="eb68e785-2f98-4539-9a2d-51bf7184dedf"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_eb68e7852f9845399a2d51bf7184dedf = function() {
            ...
            Plotly.newPlot('eb68e785-2f98-4539-9a2d-51bf7184dedf', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_eb68e7852f9845399a2d51bf7184dedf();
                };

...
<div id="acca1360-6824-4110-8c3a-3bf138d92463"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_acca1360682441108c3a3bf138d92463 = function() {
            ...
            Plotly.newPlot('acca1360-6824-4110-8c3a-3bf138d92463', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_acca1360682441108c3a3bf138d92463();
                };

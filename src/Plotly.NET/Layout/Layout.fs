...
type Layout() = 
    ...
    static member init
        (   
            ...
            [<Optional;DefaultParameterValue(null)>] ?PaperBGColor           : string,
            [<Optional;DefaultParameterValue(null)>] ?PlotBGColor            : string,
            ...
            [<Optional;DefaultParameterValue(null)>] ?Colorway               : seq<string>,
            ...
            [<Optional;DefaultParameterValue(null)>] ?PieColorWay            : seq<string>,
            ...
            [<Optional;DefaultParameterValue(null)>] ?FunnelAreaColorWay     : seq<string>, 
            [<Optional;DefaultParameterValue(null)>] ?ExtendSunBurstColors   : bool,
            [<Optional;DefaultParameterValue(null)>] ?SunBurstColorWay       : seq<string>,
            [<Optional;DefaultParameterValue(null)>] ?ExtendTreeMapColors    : bool,
            [<Optional;DefaultParameterValue(null)>] ?TreeMapColorWay        : seq<string>,            
            [<Optional;DefaultParameterValue(null)>] ?ExtendIcicleColors     : bool,
            [<Optional;DefaultParameterValue(null)>] ?IcicleColorWay         : seq<string>,

...
type Geo() = 
    ...
    static member init
        (   
           [<Optional;DefaultParameterValue(null)>] ?FitBounds,
           [<Optional;DefaultParameterValue(null)>] ?Resolution,
           [<Optional;DefaultParameterValue(null)>] ?Scope,
           [<Optional;DefaultParameterValue(null)>] ?Projection,
           ...
           [<Optional;DefaultParameterValue(null)>] ?ShowCoastLines,
           [<Optional;DefaultParameterValue(null)>] ?CoastLineColor,
           [<Optional;DefaultParameterValue(null)>] ?CoastLineWidth,
           [<Optional;DefaultParameterValue(null)>] ?ShowLand,
           [<Optional;DefaultParameterValue(null)>] ?LandColor,
           [<Optional;DefaultParameterValue(null)>] ?ShowOcean,
           [<Optional;DefaultParameterValue(null)>] ?OceanColor,
           [<Optional;DefaultParameterValue(null)>] ?ShowLakes,
           [<Optional;DefaultParameterValue(null)>] ?LakeColor,
           [<Optional;DefaultParameterValue(null)>] ?ShowRivers,
           [<Optional;DefaultParameterValue(null)>] ?RiverColor,
           [<Optional;DefaultParameterValue(null)>] ?RiverWidth,
           [<Optional;DefaultParameterValue(null)>] ?ShowCountries,
           [<Optional;DefaultParameterValue(null)>] ?CountryColor,
           [<Optional;DefaultParameterValue(null)>] ?CountryWidth,
           [<Optional;DefaultParameterValue(null)>] ?ShowSubunits,
           [<Optional;DefaultParameterValue(null)>] ?SubunitColor,
           [<Optional;DefaultParameterValue(null)>] ?SubunitWidth,
           [<Optional;DefaultParameterValue(null)>] ?ShowFrame,
           [<Optional;DefaultParameterValue(null)>] ?FrameColor,
           [<Optional;DefaultParameterValue(null)>] ?FrameWidth,
           [<Optional;DefaultParameterValue(null)>] ?BgColor,
           [<Optional;DefaultParameterValue(null)>] ?LatAxis,
           [<Optional;DefaultParameterValue(null)>] ?LonAxis

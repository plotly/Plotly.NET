...
type RadialAxis () =
    ...
    static member init 
        (
            ...
            [<Optional;DefaultParameterValue(null)>] ?AxisType           ,
            [<Optional;DefaultParameterValue(null)>] ?AutoTypeNumbers    ,
            [<Optional;DefaultParameterValue(null)>] ?AutoRange          ,
            [<Optional;DefaultParameterValue(null)>] ?RangeMode          ,
            [<Optional;DefaultParameterValue(null)>] ?Range              ,
            [<Optional;DefaultParameterValue(null)>] ?CategoryOrder      ,
            [<Optional;DefaultParameterValue(null)>] ?CategoryArray      ,
            [<Optional;DefaultParameterValue(null)>] ?Angle              ,
            [<Optional;DefaultParameterValue(null)>] ?Side               ,
            [<Optional;DefaultParameterValue(null)>] ?Title              ,
            [<Optional;DefaultParameterValue(null)>] ?HoverFormat        ,
            [<Optional;DefaultParameterValue(null)>] ?UIRevision         ,
            [<Optional;DefaultParameterValue(null)>] ?Color              ,
            [<Optional;DefaultParameterValue(null)>] ?ShowLine           ,
            [<Optional;DefaultParameterValue(null)>] ?LineColor          ,
            [<Optional;DefaultParameterValue(null)>] ?LineWidth          ,
            [<Optional;DefaultParameterValue(null)>] ?ShowGrid           ,
            [<Optional;DefaultParameterValue(null)>] ?GridColor          ,
            [<Optional;DefaultParameterValue(null)>] ?GridWidth          ,
            [<Optional;DefaultParameterValue(null)>] ?TickMode           ,
            [<Optional;DefaultParameterValue(null)>] ?NTicks             ,
            [<Optional;DefaultParameterValue(null)>] ?Tick0              ,
            [<Optional;DefaultParameterValue(null)>] ?DTick              ,
            [<Optional;DefaultParameterValue(null)>] ?TickVals           ,
            [<Optional;DefaultParameterValue(null)>] ?TickText           ,
            [<Optional;DefaultParameterValue(null)>] ?Ticks              ,
            [<Optional;DefaultParameterValue(null)>] ?TickLen            ,
            [<Optional;DefaultParameterValue(null)>] ?TickWidth          ,
            [<Optional;DefaultParameterValue(null)>] ?TickColor          ,
            [<Optional;DefaultParameterValue(null)>] ?ShowTickLabels     ,
            [<Optional;DefaultParameterValue(null)>] ?ShowTickPrefix     ,
            [<Optional;DefaultParameterValue(null)>] ?TickPrefix         ,
            [<Optional;DefaultParameterValue(null)>] ?ShowTickSuffix     ,
            [<Optional;DefaultParameterValue(null)>] ?TickSuffix         ,
            [<Optional;DefaultParameterValue(null)>] ?ShowExponent       ,
            [<Optional;DefaultParameterValue(null)>] ?ExponentFormat     ,
            [<Optional;DefaultParameterValue(null)>] ?MinExponent        ,
            [<Optional;DefaultParameterValue(null)>] ?SeparateThousands  ,
            [<Optional;DefaultParameterValue(null)>] ?TickFont           ,
            [<Optional;DefaultParameterValue(null)>] ?TickAngle          ,
            [<Optional;DefaultParameterValue(null)>] ?TickFormat         ,
            [<Optional;DefaultParameterValue(null)>] ?TickFormatStops    ,
            [<Optional;DefaultParameterValue(null)>] ?Layer              ,
            [<Optional;DefaultParameterValue(null)>] ?Calendar           
        ) =
            RadialAxis() 
            |> RadialAxis.style 
                (

...
module TraceObjects =
    ...
    type IMapZ =
        ...
        abstract ShouldSerializex0             : unit -> bool
        abstract ShouldSerializedx             : unit -> bool
        abstract ShouldSerializey0             : unit -> bool
        abstract ShouldSerializedy             : unit -> bool     
        abstract ShouldSerializextype          : unit -> bool
        abstract ShouldSerializeytype          : unit -> bool     
        abstract ShouldSerializexaxis          : unit -> bool
        abstract ShouldSerializeyaxis          : unit -> bool                      
    ...
    type IHistogram =
        ...
        abstract ShouldSerializehistfunc      : unit -> bool
        abstract ShouldSerializehistnorm      : unit -> bool
        abstract ShouldSerializeautobinx      : unit -> bool
        abstract ShouldSerializenbinsx        : unit -> bool
        abstract ShouldSerializexbins         : unit -> bool
        abstract ShouldSerializeautobiny      : unit -> bool
        abstract ShouldSerializenbinsy        : unit -> bool
        abstract ShouldSerializeybins         : unit -> bool
        abstract ShouldSerializeorientation   : unit -> bool
    ...
    type Histogram() =
        ...
        let mutable _xbins: Bins option = None
        let mutable _autobiny: bool option = None
        let mutable _nbinsy: int option = None
        let mutable _ybins: Bins option = None
        let mutable _orientation: obj option = None

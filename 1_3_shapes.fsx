...
<div id="257b594b-0680-4aca-8b6f-aa7decabbdf2" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_257b594b06804aca8b6faa7decabbdf2 = function() {
            ...
            var config = {};
            Plotly.newPlot('257b594b-0680-4aca-8b6f-aa7decabbdf2', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_257b594b06804aca8b6faa7decabbdf2();
                };

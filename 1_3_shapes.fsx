...
<div id="741aa3ff-b43d-45cd-bd5d-163246959474" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_741aa3ffb43d45cdbd5d163246959474 = function() {
            ...
            var config = {};
            Plotly.newPlot('741aa3ff-b43d-45cd-bd5d-163246959474', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_741aa3ffb43d45cdbd5d163246959474();
                };

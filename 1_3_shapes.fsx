...
<div id="e3c6c6ae-41e8-4259-b985-71f2a8fd92bf" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_e3c6c6ae41e84259b98571f2a8fd92bf = function() {
            ...
            var config = {};
            Plotly.newPlot('e3c6c6ae-41e8-4259-b985-71f2a8fd92bf', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_e3c6c6ae41e84259b98571f2a8fd92bf();
                };

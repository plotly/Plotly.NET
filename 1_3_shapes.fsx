...
<div id="b0d6607b-052e-429d-819b-ad3b5c1b60c0" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_b0d6607b052e429d819bad3b5c1b60c0 = function() {
            ...
            var config = {};
            Plotly.newPlot('b0d6607b-052e-429d-819b-ad3b5c1b60c0', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_b0d6607b052e429d819bad3b5c1b60c0();
                };

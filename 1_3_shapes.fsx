...
<div id="4dac7d37-0771-449d-bc25-9190550c8808" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_4dac7d370771449dbc259190550c8808 = function() {
            ...
            var config = {};
            Plotly.newPlot('4dac7d37-0771-449d-bc25-9190550c8808', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_4dac7d370771449dbc259190550c8808();
                };

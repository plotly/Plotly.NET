...
<div id="f18ca43c-9df2-426c-ad03-5c76e0008ee9" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f18ca43c9df2426cad035c76e0008ee9 = function() {
            ...
            var config = {};
            Plotly.newPlot('f18ca43c-9df2-426c-ad03-5c76e0008ee9', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f18ca43c9df2426cad035c76e0008ee9();
                };

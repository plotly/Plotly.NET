...
<div id="7b047299-045d-4d51-ac28-c4c7b82dab8b" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_7b047299045d4d51ac28c4c7b82dab8b = function() {
            ...
            var config = {};
            Plotly.newPlot('7b047299-045d-4d51-ac28-c4c7b82dab8b', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_7b047299045d4d51ac28c4c7b82dab8b();
                };

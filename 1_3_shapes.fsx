...
<div id="e4f379cb-bbd0-4210-9392-05fed516edd8" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_e4f379cbbbd04210939205fed516edd8 = function() {
            ...
            var config = {};
            Plotly.newPlot('e4f379cb-bbd0-4210-9392-05fed516edd8', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_e4f379cbbbd04210939205fed516edd8();
                };

...
<div id="6e33e161-acee-45be-95ac-1e15d8af258d"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_6e33e161acee45be95ac1e15d8af258d = function() {
            ...
            Plotly.newPlot('6e33e161-acee-45be-95ac-1e15d8af258d', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_6e33e161acee45be95ac1e15d8af258d();
                };
...
let moreFeaturesBaseMap =
    ...
    |> Chart.withGeo myGeo
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="a6b59545-2195-4d7c-a2eb-4b3b12299db9"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_a6b5954521954d7ca2eb4b3b12299db9 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.4.2.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('a6b59545-2195-4d7c-a2eb-4b3b12299db9', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_a6b5954521954d7ca2eb4b3b12299db9();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
let countryBaseMap =
    ...
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="a75345bc-5d54-4624-968c-d7e3721de26e"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_a75345bc5d544624968cd7e3721de26e = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.4.2.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('a75345bc-5d54-4624-968c-d7e3721de26e', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_a75345bc5d544624968cd7e3721de26e();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

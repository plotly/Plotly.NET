...
**This page documents Geo outline-based maps, and the [Mapbox Layers documentation]()(https://plotly.net//06**0**geo-vs-mapbox.html) describes how to configure Mapbox tile-based maps.**
...
<div id="48d1e972-6189-454d-93a8-4025a90cafea"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_48d1e9726189454d93a84025a90cafea = function() {
            ...
            Plotly.newPlot('48d1e972-6189-454d-93a8-4025a90cafea', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_48d1e9726189454d93a84025a90cafea();
                };
...
let moreFeaturesBaseMap =
    ...
    |> Chart.withGeo myGeo
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="0e489856-534b-49aa-acb5-e916e1ccbe62"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_0e489856534b49aaacb5e916e1ccbe62 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('0e489856-534b-49aa-acb5-e916e1ccbe62', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_0e489856534b49aaacb5e916e1ccbe62();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
let countryBaseMap =
    ...
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="4bfec86c-7095-461b-aa9b-9babaedf6423"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_4bfec86c7095461baa9b9babaedf6423 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('4bfec86c-7095-461b-aa9b-9babaedf6423', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_4bfec86c7095461baa9b9babaedf6423();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

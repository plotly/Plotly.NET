...
<div id="b327683d-642e-4651-9e5a-06ab0acf97f3"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_b327683d642e46519e5a06ab0acf97f3 = function() {
            ...
            Plotly.newPlot('b327683d-642e-4651-9e5a-06ab0acf97f3', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_b327683d642e46519e5a06ab0acf97f3();
                };
...
let moreFeaturesBaseMap =
    ...
    |> Chart.withGeo myGeo
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="3cacacce-4b25-41fd-9713-9a71ca4c0ff0"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_3cacacce4b2541fd97139a71ca4c0ff0 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.4.2.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('3cacacce-4b25-41fd-9713-9a71ca4c0ff0', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_3cacacce4b2541fd97139a71ca4c0ff0();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
let countryBaseMap =
    ...
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="039c5c53-ac1b-4fd3-b44b-1a631cf59958"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_039c5c53ac1b4fd3b44b1a631cf59958 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.4.2.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('039c5c53-ac1b-4fd3-b44b-1a631cf59958', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_039c5c53ac1b4fd3b44b1a631cf59958();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

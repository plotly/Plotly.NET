...
<div id="1716e5a1-7f2f-4d3a-b733-3a78bbb5ba0f"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_1716e5a17f2f4d3ab7333a78bbb5ba0f = function() {
            ...
            Plotly.newPlot('1716e5a1-7f2f-4d3a-b733-3a78bbb5ba0f', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_1716e5a17f2f4d3ab7333a78bbb5ba0f();
                };
...
let moreFeaturesBaseMap =
    ...
    |> Chart.withGeo myGeo
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="bd841b1d-7118-4748-aced-b052ca64ad95"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_bd841b1d71184748acedb052ca64ad95 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('bd841b1d-7118-4748-aced-b052ca64ad95', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_bd841b1d71184748acedb052ca64ad95();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
let countryBaseMap =
    ...
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="b23ed549-c5f6-48f1-9337-9ef852918aab"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_b23ed549c5f648f193379ef852918aab = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('b23ed549-c5f6-48f1-9337-9ef852918aab', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_b23ed549c5f648f193379ef852918aab();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

...
<div id="9a86af4f-89d9-41a3-95da-59df2abd193e"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_9a86af4f89d941a395da59df2abd193e = function() {
            ...
            Plotly.newPlot('9a86af4f-89d9-41a3-95da-59df2abd193e', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_9a86af4f89d941a395da59df2abd193e();
                };
...
let moreFeaturesBaseMap =
    ...
    |> Chart.withGeo myGeo
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="004e236e-a1db-4b4b-888a-8150dcdfa3c4"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_004e236ea1db4b4b888a8150dcdfa3c4 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('004e236e-a1db-4b4b-888a-8150dcdfa3c4', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_004e236ea1db4b4b888a8150dcdfa3c4();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
let countryBaseMap =
    ...
    |> Chart.withMarginSize(0,0,0,0)(* output: 
<div id="c543b480-7cb7-4f3f-834b-dd1a3d639235"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c543b4807cb74f3f834bdd1a3d639235 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('c543b480-7cb7-4f3f-834b-dd1a3d639235', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_c543b4807cb74f3f834bdd1a3d639235();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

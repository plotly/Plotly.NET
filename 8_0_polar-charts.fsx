...
[![Binder](https://plotly.net/img/badge-binder.svg)](https://mybinder.org/v2/gh/plotly/Plotly.NET/gh-pages?filepath=8_0_polar-charts.ipynb)&emsp;
[![Script](https://plotly.net/img/badge-script.svg)](https://plotly.net/8_0_polar-charts.fsx)&emsp;
[![Notebook](https://plotly.net/img/badge-notebook.svg)](https://plotly.net/8_0_polar-charts.ipynb)
...
<div id="dddaa15c-f5f2-47b3-ac6a-af4e85453e79" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_dddaa15cf5f247b3ac6aaf4e85453e79 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('dddaa15c-f5f2-47b3-ac6a-af4e85453e79', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_dddaa15cf5f247b3ac6aaf4e85453e79();
                };

...
<div id="69c7671d-4e7e-4e59-bafb-59b39a6c4416" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_69c7671d4e7e4e59bafb59b39a6c4416 = function() {
            ...
            var config = {};
            Plotly.newPlot('69c7671d-4e7e-4e59-bafb-59b39a6c4416', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_69c7671d4e7e4e59bafb59b39a6c4416();
                };

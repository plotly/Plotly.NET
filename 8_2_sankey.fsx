...
<div id="06d62965-f31b-4302-b313-c8c528abb476" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_06d62965f31b4302b313c8c528abb476 = function() {
            ...
            var config = {};
            Plotly.newPlot('06d62965-f31b-4302-b313-c8c528abb476', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_06d62965f31b4302b313c8c528abb476();
                };

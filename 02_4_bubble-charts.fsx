...
<div id="c5355f9d-6dc3-41e6-9b66-a86cb1fde00c"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c5355f9d6dc341e69b66a86cb1fde00c = function() {
            ...
            Plotly.newPlot('c5355f9d-6dc3-41e6-9b66-a86cb1fde00c', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_c5355f9d6dc341e69b66a86cb1fde00c();
                };

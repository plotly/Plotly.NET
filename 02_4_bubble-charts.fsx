...
<div id="7cba0ac9-3453-4ab3-b182-423d5ddac9dc"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_7cba0ac934534ab3b182423d5ddac9dc = function() {
            ...
            Plotly.newPlot('7cba0ac9-3453-4ab3-b182-423d5ddac9dc', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_7cba0ac934534ab3b182423d5ddac9dc();
                };

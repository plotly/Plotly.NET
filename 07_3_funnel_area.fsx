...
<div id="cf336deb-1817-4ebd-ba3d-cb9138d04d3f"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_cf336deb18174ebdba3dcb9138d04d3f = function() {
            ...
            Plotly.newPlot('cf336deb-1817-4ebd-ba3d-cb9138d04d3f', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_cf336deb18174ebdba3dcb9138d04d3f();
                };

...
<div id="f3502b40-e738-453c-8e73-485aaa77f510"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f3502b40e738453c8e73485aaa77f510 = function() {
            ...
            Plotly.newPlot('f3502b40-e738-453c-8e73-485aaa77f510', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f3502b40e738453c8e73485aaa77f510();
                };

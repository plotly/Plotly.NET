...
<div id="b9bb58b9-4caa-4f20-9265-003afb42bd5f"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_b9bb58b94caa4f209265003afb42bd5f = function() {
            ...
            Plotly.newPlot('b9bb58b9-4caa-4f20-9265-003afb42bd5f', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_b9bb58b94caa4f209265003afb42bd5f();
                };

...
<div id="d38917a1-2ea5-41b9-8811-ffe52343c54c"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_d38917a12ea541b98811ffe52343c54c = function() {
            ...
            Plotly.newPlot('d38917a1-2ea5-41b9-8811-ffe52343c54c', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_d38917a12ea541b98811ffe52343c54c();
                };

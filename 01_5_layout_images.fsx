...
<div id="dbd26570-a51a-419a-80f0-64d0164e698d"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_dbd26570a51a419a80f064d0164e698d = function() {
            ...
            Plotly.newPlot('dbd26570-a51a-419a-80f0-64d0164e698d', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_dbd26570a51a419a80f064d0164e698d();
                };

...
<div id="a75db139-1ea7-4100-a94e-44cb19b8084f"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_a75db1391ea74100a94e44cb19b8084f = function() {
            ...
            Plotly.newPlot('a75db139-1ea7-4100-a94e-44cb19b8084f', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_a75db1391ea74100a94e44cb19b8084f();
                };

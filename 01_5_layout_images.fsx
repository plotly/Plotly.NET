...
<div id="b87a023a-79d4-455e-988c-10c55f990523"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_b87a023a79d4455e988c10c55f990523 = function() {
            ...
            Plotly.newPlot('b87a023a-79d4-455e-988c-10c55f990523', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_b87a023a79d4455e988c10c55f990523();
                };

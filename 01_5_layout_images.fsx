...
<div id="c610623e-c6e9-4442-8e92-e6b1d2a0ffa8"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c610623ec6e944428e92e6b1d2a0ffa8 = function() {
            ...
            Plotly.newPlot('c610623e-c6e9-4442-8e92-e6b1d2a0ffa8', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_c610623ec6e944428e92e6b1d2a0ffa8();
                };

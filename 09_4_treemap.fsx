(**
// can't yet format YamlFrontmatter (["title: Treemap Charts"; "category: Categorical Charts"; "categoryindex: 10"; "index: 5"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown

# Treemap charts

[![Binder](https://plotly.net/img/badge-binder.svg)](https://mybinder.org/v2/gh/plotly/Plotly.NET/gh-pages?filepath=09_4_treemap.ipynb)&emsp;
[![Script](https://plotly.net/img/badge-script.svg)](https://plotly.net/09_4_treemap.fsx)&emsp;
[![Notebook](https://plotly.net/img/badge-notebook.svg)](https://plotly.net/09_4_treemap.ipynb)
...
<div id="99cc4205-9e7e-4bf4-a90e-751040e67eed"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_99cc42059e7e4bf4a90e751040e67eed = function() {
            ...
            Plotly.newPlot('99cc4205-9e7e-4bf4-a90e-751040e67eed', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_99cc42059e7e4bf4a90e751040e67eed();
                };

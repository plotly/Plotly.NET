...
<div id="74a2c14b-803a-4b63-8f91-688b8ba26a16" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_74a2c14b803a4b638f91688b8ba26a16 = function() {
            ...
            var config = {};
            Plotly.newPlot('74a2c14b-803a-4b63-8f91-688b8ba26a16', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_74a2c14b803a4b638f91688b8ba26a16();
                };

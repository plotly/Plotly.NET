...
[![Binder](https://plotly.net/img/badge-binder.svg)](https://mybinder.org/v2/gh/plotly/Plotly.NET/gh-pages?filepath=6_0_geo-vs-mapbox.ipynb)&emsp;
[![Script](https://plotly.net/img/badge-script.svg)](https://plotly.net/6_0_geo-vs-mapbox.fsx)&emsp;
[![Notebook](https://plotly.net/img/badge-notebook.svg)](https://plotly.net/6_0_geo-vs-mapbox.ipynb)
...
_This page documents Mapbox tile-based maps, and the [Geo map documentation](https://plotly.net//5_0_geo-vs-mapbox.html) describes how to configure outline-based maps_
...
<div id="0e45b97b-2660-41fb-a71b-adfc92748f00" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_0e45b97b266041fba71badfc92748f00 = function() {
            ...
            var config = {};
            Plotly.newPlot('0e45b97b-2660-41fb-a71b-adfc92748f00', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_0e45b97b266041fba71badfc92748f00();
                };

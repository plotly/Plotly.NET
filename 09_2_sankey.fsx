...
<div id="e4beb32a-6243-4485-b7f0-4bfd9f36435f"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_e4beb32a62434485b7f04bfd9f36435f = function() {
            ...
            Plotly.newPlot('e4beb32a-6243-4485-b7f0-4bfd9f36435f', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_e4beb32a62434485b7f04bfd9f36435f();
                };

...
<div id="2d29688a-844a-4c8b-bccf-258a5104bb79" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_2d29688a844a4c8bbccf258a5104bb79 = function() {
            ...
            var config = {};
            Plotly.newPlot('2d29688a-844a-4c8b-bccf-258a5104bb79', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_2d29688a844a4c8bbccf258a5104bb79();
                };

...
<div id="9f208e50-15a1-4050-a8d5-8bdcde098fae"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_9f208e5015a14050a8d58bdcde098fae = function() {
            ...
            Plotly.newPlot('9f208e50-15a1-4050-a8d5-8bdcde098fae', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_9f208e5015a14050a8d58bdcde098fae();
                };

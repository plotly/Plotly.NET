...
<div id="13d22a91-96a3-4cde-90b7-454d52aa07f8"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_13d22a9196a34cde90b7454d52aa07f8 = function() {
            ...
            Plotly.newPlot('13d22a91-96a3-4cde-90b7-454d52aa07f8', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_13d22a9196a34cde90b7454d52aa07f8();
                };

...
[![Binder](https://plotly.net/img/badge-binder.svg)](https://mybinder.org/v2/gh/plotly/Plotly.NET/gh-pages?filepath=01_1_errorbars.ipynb)&emsp;
[![Script](https://plotly.net/img/badge-script.svg)](https://plotly.net/01_1_errorbars.fsx)&emsp;
[![Notebook](https://plotly.net/img/badge-notebook.svg)](https://plotly.net/01_1_errorbars.ipynb)
...
<div id="ab4f661b-9a13-4d2d-b3a0-166d1eb4922e" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_ab4f661b9a134d2db3a0166d1eb4922e = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('ab4f661b-9a13-4d2d-b3a0-166d1eb4922e', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_ab4f661b9a134d2db3a0166d1eb4922e();
                };

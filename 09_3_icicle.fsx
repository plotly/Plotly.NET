...
<div id="8a9e316e-e059-4f96-96f4-2f93cfddd752"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_8a9e316ee0594f9696f42f93cfddd752 = function() {
            ...
            Plotly.newPlot('8a9e316e-e059-4f96-96f4-2f93cfddd752', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_8a9e316ee0594f9696f42f93cfddd752();
                };

...
<div id="21ee58bf-e1e0-4a9e-9c5c-15f1a1bafe9e"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_21ee58bfe1e04a9e9c5c15f1a1bafe9e = function() {
            ...
            Plotly.newPlot('21ee58bf-e1e0-4a9e-9c5c-15f1a1bafe9e', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_21ee58bfe1e04a9e9c5c15f1a1bafe9e();
                };

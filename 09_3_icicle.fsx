...
<div id="3369432a-21cd-4b60-8458-af8ef8494db5"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_3369432a21cd4b608458af8ef8494db5 = function() {
            ...
            Plotly.newPlot('3369432a-21cd-4b60-8458-af8ef8494db5', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_3369432a21cd4b608458af8ef8494db5();
                };
...
<div id="85bec355-c2c9-4dd4-abb0-be7ab728f5e4"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_85bec355c2c94dd4abb0be7ab728f5e4 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('85bec355-c2c9-4dd4-abb0-be7ab728f5e4', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_85bec355c2c94dd4abb0be7ab728f5e4();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

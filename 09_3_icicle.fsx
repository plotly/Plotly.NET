...
<div id="7b96a417-adb2-414a-8a3e-5d56918e09bd"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_7b96a417adb2414a8a3e5d56918e09bd = function() {
            ...
            Plotly.newPlot('7b96a417-adb2-414a-8a3e-5d56918e09bd', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_7b96a417adb2414a8a3e5d56918e09bd();
                };

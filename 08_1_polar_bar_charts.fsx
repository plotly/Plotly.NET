...
<div id="9e4dd57a-9264-4d7e-a004-e674c3223288"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_9e4dd57a92644d7ea004e674c3223288 = function() {
            ...
            Plotly.newPlot('9e4dd57a-9264-4d7e-a004-e674c3223288', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_9e4dd57a92644d7ea004e674c3223288();
                };

...
<div id="35d2d4cc-3041-4a8c-a1f7-11460973496f"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_35d2d4cc30414a8ca1f711460973496f = function() {
            ...
            Plotly.newPlot('35d2d4cc-3041-4a8c-a1f7-11460973496f', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_35d2d4cc30414a8ca1f711460973496f();
                };

...
<div id="bca4a57c-2778-4530-b69d-724b27ea52a1"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_bca4a57c27784530b69d724b27ea52a1 = function() {
            ...
            Plotly.newPlot('bca4a57c-2778-4530-b69d-724b27ea52a1', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_bca4a57c27784530b69d724b27ea52a1();
                };

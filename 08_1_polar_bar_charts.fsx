...
<div id="944c8659-f580-422c-8f3b-a9f2a7ff51f9"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_944c8659f580422c8f3ba9f2a7ff51f9 = function() {
            ...
            Plotly.newPlot('944c8659-f580-422c-8f3b-a9f2a7ff51f9', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_944c8659f580422c8f3ba9f2a7ff51f9();
                };

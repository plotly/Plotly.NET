...
<div id="0d2d17c9-0128-4d66-b308-b751c40d8fc8" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_0d2d17c901284d66b308b751c40d8fc8 = function() {
            ...
            var config = {};
            Plotly.newPlot('0d2d17c9-0128-4d66-b308-b751c40d8fc8', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_0d2d17c901284d66b308b751c40d8fc8();
                };

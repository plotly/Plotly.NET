...
<div id="f4e651d6-2a10-4206-a691-a681b6eaa18c"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f4e651d62a104206a691a681b6eaa18c = function() {
            ...
            Plotly.newPlot('f4e651d6-2a10-4206-a691-a681b6eaa18c', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f4e651d62a104206a691a681b6eaa18c();
                };

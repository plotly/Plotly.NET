...
<div id="2b8d411e-22b6-433b-9648-c291f74843a9" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_2b8d411e22b6433b9648c291f74843a9 = function() {
            ...
            var config = {};
            Plotly.newPlot('2b8d411e-22b6-433b-9648-c291f74843a9', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_2b8d411e22b6433b9648c291f74843a9();
                };

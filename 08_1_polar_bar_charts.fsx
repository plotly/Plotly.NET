...
<div id="a57e54aa-d2d2-400c-b05f-217afb26f349"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_a57e54aad2d2400cb05f217afb26f349 = function() {
            ...
            Plotly.newPlot('a57e54aa-d2d2-400c-b05f-217afb26f349', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_a57e54aad2d2400cb05f217afb26f349();
                };

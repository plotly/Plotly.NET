...
<div id="4f9b646a-d1df-4e2c-86c6-6b0ebfb36ecf" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_4f9b646ad1df4e2c86c66b0ebfb36ecf = function() {
            ...
            var config = {};
            Plotly.newPlot('4f9b646a-d1df-4e2c-86c6-6b0ebfb36ecf', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_4f9b646ad1df4e2c86c66b0ebfb36ecf();
                };

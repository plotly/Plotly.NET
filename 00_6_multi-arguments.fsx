(**
// can't yet format YamlFrontmatter (["title: single and sulti arguments"; "category: General"; "categoryindex: 1"; "index: 7"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown
...
<div id="2d2df13d-91dc-46ba-848d-09be09876622"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_2d2df13d91dc46ba848d09be09876622 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {

            var data = [{"type":"bar","opacity":0.75,"x":[1,2,3],"y":["first","second","third"],"text":["first bar","second bar","third bar"],"textposition":"outside","orientation":"h","marker":{"pattern":{"shape":["\\",".","-"]}}}];
            ...
            Plotly.newPlot('2d2df13d-91dc-46ba-848d-09be09876622', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_2d2df13d91dc46ba848d09be09876622();
                };

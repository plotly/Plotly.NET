...
[![Binder](https://plotly.net/img/badge-binder.svg)](https://mybinder.org/v2/gh/plotly/Plotly.NET/gh-pages?filepath=8_1_windrose-charts.ipynb)&emsp;
[![Script](https://plotly.net/img/badge-script.svg)](https://plotly.net/8_1_windrose-charts.fsx)&emsp;
[![Notebook](https://plotly.net/img/badge-notebook.svg)](https://plotly.net/8_1_windrose-charts.ipynb)
...
<div id="ee813616-d004-4e73-85c7-6cd78ce056f4" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_ee813616d0044e7385c76cd78ce056f4 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('ee813616-d004-4e73-85c7-6cd78ce056f4', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_ee813616d0044e7385c76cd78ce056f4();
                };

...
<div id="ba7442f9-9c93-4193-8b4e-f808f024bdfa"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_ba7442f99c9341938b4ef808f024bdfa = function() {
            ...
            Plotly.newPlot('ba7442f9-9c93-4193-8b4e-f808f024bdfa', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_ba7442f99c9341938b4ef808f024bdfa();
                };

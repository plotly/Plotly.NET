...
[![Binder](https://plotly.net/img/badge-binder.svg)](https://mybinder.org/v2/gh/plotly/Plotly.NET/gh-pages?filepath=9_0_parallel-categories.ipynb)&emsp;
[![Script](https://plotly.net/img/badge-script.svg)](https://plotly.net/9_0_parallel-categories.fsx)&emsp;
[![Notebook](https://plotly.net/img/badge-notebook.svg)](https://plotly.net/9_0_parallel-categories.ipynb)
...
<div id="837c77ad-3b56-4b41-9999-c3a64bd5a762" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_837c77ad3b564b419999c3a64bd5a762 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('837c77ad-3b56-4b41-9999-c3a64bd5a762', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_837c77ad3b564b419999c3a64bd5a762();
                };
